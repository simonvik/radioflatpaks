...
app: dk.gqrx.App.json com.github.sdrangel.App.json
	...
	flatpak-builder --force-clean --ccache --require-changes --repo=$(REPO)2 ./build2 com.github.sdrangel.App.json

com.sdrangel.App: app
	flatpak build-bundle $(REPO)2 sdrangel.flatpak com.github.sdrangel.App
